...
public class LongestConsecutiveSequenceRefactored {
...
public int longestConsecutive(int[] nums) {
	...
	public static void main(String[] args) {
		...
		int[] nums = {0,1,-1,4,5,6,7,8};
		LongestConsecutiveSequenceRefactored lcs = new LongestConsecutiveSequenceRefactored();
